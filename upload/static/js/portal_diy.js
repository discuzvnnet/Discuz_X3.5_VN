...
drag.extend({
	...
	openStyleEdit : function (e) {
		...
		table += '<li><label>Trên</label><select class="ps vm" id="bdtwidth" ><option value="">Kích thước</option>'+this.getOption(widtharr,bdtwidth)+'</select>';
		...
		table += '<li class="bordera mtn"><label>Phải</label><select class="ps vm" id="bdrwidth" ><option value="">Kích thước</option>'+this.getOption(widtharr,bdrwidth)+'</select>';
		...
		table += '<li class="bordera mtn"><label>Dưới</label><select class="ps vm" id="bdbwidth" ><option value="">Kích thước</option>'+this.getOption(widtharr,bdbwidth)+'</select>';
		...
		table += '<li class="bordera mtn"><label>Trái</label><select class="ps vm" id="bdlwidth" ><option value="">Kích thước</option>'+this.getOption(widtharr,bdlwidth)+'</select>';
		...
		table += '<tr><th>Margin</th><td><div id="margindiv" class="'+ulclass+'"><span><label>Trên</label> <input type="text" id="margint" class="px p_fre vm" value="'+margint+'" size="1"/>px </span>';
		...
		if (objType == 1) {
			...
			table += '<tr><th>Padding</th><td><div id="cmargindiv" class="'+ulclass+'"><span><label>Trên</label> <input class="px p_fre" id="cmargint" value="'+cmargint+'" size="1" />px </span>';
