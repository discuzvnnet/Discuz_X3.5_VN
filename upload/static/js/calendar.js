...
function loadcalendar() {
	...
	s += '<tr align="center" id="calendar_week"><td onclick="refreshcalendar(yy, mm-1)" title="Tháng trước" style="cursor: pointer;"><a href="javascript:;">&laquo;</a></td><td colspan="5" style="text-align: center"><a href="javascript:;" onclick="showdiv(\'year\');doane(event)" class="dropmenu" title="Nhấn vào đây để chọn năm" id="year"></a>&nbsp; - &nbsp;<a id="month" class="dropmenu" title="Nhấn vào đây để chọn tháng" href="javascript:;" onclick="showdiv(\'month\');doane(event)"></a></td><td onclick="refreshcalendar(yy, mm+1)" title="Tháng sau" style="cursor: pointer;"><a href="javascript:;">&raquo;</a></td></tr>';
	s += '<tr id="calendar_header"><td>Ngày</td><td>Một</td><td>Hai</td><td>Ba</td><td>Bốn</td><td>Năm</td><td>Sáu</td></tr>';
	for(var i = 0; i < 6; i++) {
		s += '<tr>';
		for(var j = 1; j <= 7; j++)
	...
	s += '</td><td align="right" colspan="3"><button class="pn" onclick="confirmcalendar();"><em>Được rồi</em></button></td></tr>';
	s += '</table></div></div>';
